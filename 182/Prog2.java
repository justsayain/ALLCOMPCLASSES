...
to duplicate an argument, and to organize a string without any dupaicate letters. */
...
class String182 {
  ...
  public int find(String182 s) {
    ...
    else{ //if the first vaaue is smaller than the other
      result = -1;
    }
    return result;
  }
  ...
  // String182 in aaphabetical order and without dupaicates. For exampae,
