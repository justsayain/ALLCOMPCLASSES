   ...
   // copy constructor  
      ...
      private static IntNode copy(IntNode L){ //T(n)=O(logn) 
         IntNode temp=null;  
      ...
      private static IntNode delete(IntNode T, int num){	//T(n)=O(n)  
         ...
         if(T==null){}  
            ...
            if(T.getLeft()==null) //no left child
               ...
               Pred=T.getLeft(); //gets highest # from left subtree
               while(Pred.getRight()!=null){
                  Pred=Pred.getRight();
               }
               T=Pred;
               T.setLeft(delete(Ptr.getLeft(),Pred.getNum()));
               T.setRight(Ptr.getRight());
            }
